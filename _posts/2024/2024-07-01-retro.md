...
Another quarter done. It's been a pretty eventful year so far, and there's
definitely ways in which I've grown and am proud of, and areas that I'd still
need more focus on to improve in.
...
since I started a fully remote role. In terms of my relationship with my
partner, things have been good, but we've both agreed that communication tends
to take a nosedive when either of us is stressed (which has been rather often
for me...). It's not a cause for alarm, but it is an area that we're both
